"""Tests for winipedia_utils.pyside.ui.base.base module."""
...
from winipedia_utils.pyside.ui.base.base import Base, QABCLoggingMeta
...
class TestBase:
    ...
    def test_get_subclasses(self, mocker: MockerFixture) -> None:
        ...
        mocker.patch(
            "winipedia_utils.pyside.ui.base.base.get_main_package",
            return_value=mock_package,
        )
        mocker.patch(
            "winipedia_utils.pyside.ui.base.base.walk_package", return_value=[]
        )
        ...
        mocker.patch(
            "winipedia_utils.pyside.ui.base.base.get_all_nonabstract_subclasses",
