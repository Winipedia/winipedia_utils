"""Tests for winipedia_utils.pyside.ui.pages.browser module."""

from PySide6.QtWidgets import QVBoxLayout
from pytest_mock import MockerFixture

from winipedia_utils.pyside.ui.pages.browser import Browser
...
class TestBrowser:
    ...
    def test_add_brwoser(self, mocker: MockerFixture) -> None:
        ...
        mock_browser_widget_class = mocker.patch(
            "winipedia_utils.pyside.ui.pages.browser.BrowserWidget"
        )
