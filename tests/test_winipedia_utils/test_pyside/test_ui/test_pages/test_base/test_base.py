...
from winipedia_utils.pyside.ui.pages.base.base import Base
...
class TestBase:
    ...
    def test_base_setup(self, mocker: MockFixture) -> None:
        ...
        mock_qvboxlayout = mocker.patch(
            "winipedia_utils.pyside.ui.pages.base.base.QVBoxLayout"
        )
        mock_qhboxlayout = mocker.patch(
            "winipedia_utils.pyside.ui.pages.base.base.QHBoxLayout"
        )
    ...
    def test_add_menu_dropdown_button(self, mocker: MockFixture) -> None:
        ...
        mock_qpushbutton = mocker.patch(
            "winipedia_utils.pyside.ui.pages.base.base.QPushButton"
        )
        mock_qmenu = mocker.patch("winipedia_utils.pyside.ui.pages.base.base.QMenu")
