"""Tests for winipedia_utils.pyside.ui.pages.player module."""
...
from winipedia_utils.pyside.ui.pages.player import Player
...
class TestPlayer:
    ...
    def test_setup(self, mocker: MockerFixture) -> None:
        ...
        mock_media_player_class = mocker.patch(
            "winipedia_utils.pyside.ui.pages.player.MediaPlayer"
        )
