...
class TestMediaPlayer:
    ...
    def test_make_widget(self, mocker: MockFixture) -> None:
        ...
        mock_qwidget = mocker.patch(
            "winipedia_utils.pyside.ui.widgets.media_player.QWidget"
        )
        mock_qvboxlayout = mocker.patch(
            "winipedia_utils.pyside.ui.widgets.media_player.QVBoxLayout"
        )
    ...
    def test_make_video_widget(self, mocker: MockFixture) -> None:
        ...
        mock_clickable_widget = mocker.patch(
            "winipedia_utils.pyside.ui.widgets.media_player.ClickableVideoWidget"
        )
        mock_audio_output = mocker.patch(
            "winipedia_utils.pyside.ui.widgets.media_player.QAudioOutput"
        )
    ...
    def test_add_media_controls_above(self, mocker: MockFixture) -> None:
        ...
        mock_qhboxlayout = mocker.patch(
            "winipedia_utils.pyside.ui.widgets.media_player.QHBoxLayout"
        )
    ...
    def test_add_playback_control(self, mocker: MockFixture) -> None:
        ...
        mock_get_icon = mocker.patch(
            "winipedia_utils.pyside.ui.widgets.media_player.BaseUI.get_svg_icon"
        )
        mock_button = mocker.patch(
            "winipedia_utils.pyside.ui.widgets.media_player.QPushButton"
        )
    ...
    def test_add_speed_control(self, mocker: MockFixture) -> None:
        ...
        mock_menu = mocker.patch("winipedia_utils.pyside.ui.widgets.media_player.QMenu")
    ...
    def test_add_volume_control(self, mocker: MockFixture) -> None:
        ...
        player = MediaPlayer.__new__(MediaPlayer)
        player.left_controls_layout = mocker.MagicMock()
        mock_slider = mocker.patch(
            "winipedia_utils.pyside.ui.widgets.media_player.QSlider"
        )
    ...
    def test_on_slider_moved(self, mocker: MockFixture) -> None:
        ...
        mock_time = mocker.patch("winipedia_utils.pyside.ui.widgets.media_player.time")
    ...
    def test_play_video(self, mocker: MockFixture) -> None:
        ...
        mock_partial = mocker.patch(
            "winipedia_utils.pyside.ui.widgets.media_player.partial"
        )
    ...
    def test_play_file(self, mocker: MockFixture) -> None:
        ...
        mock_pyq_file = mocker.patch(
            "winipedia_utils.pyside.ui.widgets.media_player.PyQFile"
        )
        mock_qurl = mocker.patch("winipedia_utils.pyside.ui.widgets.media_player.QUrl")
    ...
    def test_play_encrypted_file(self, mocker: MockFixture) -> None:
        ...
        mock_encrypted_file = mocker.patch(
            "winipedia_utils.pyside.ui.widgets.media_player.EncryptedPyQFile"
        )
        mock_qurl = mocker.patch("winipedia_utils.pyside.ui.widgets.media_player.QUrl")
