...
def test_find_packages(mocker: MockFixture) -> None:
    ...
    mock_find_packages = mocker.patch(
        "winipedia_utils.utils.modules.package._find_packages",
...
def test_find_packages_with_namespace(mocker: MockFixture) -> None:
    ...
    mock_find_namespace = mocker.patch(
        "winipedia_utils.utils.modules.package._find_namespace_packages",
...
def test_get_main_package(mocker: MockFixture) -> None:
    ...
    mocker.patch("winipedia_utils.utils.modules.package.sys", mock_sys)

    mock_import_module = mocker.patch(
        "winipedia_utils.utils.modules.package.import_module"
    )
...
class TestDependencyGraph:
    ...
    def test_get_all_depending_on_winipedia_utils(self, mocker: MockFixture) -> None:
        ...
        mocker.patch(
            make_obj_importpath(get_src_package),
