...
from winipedia_utils.testing.create_tests import (
    create_test_module,
    create_test_package,
    create_tests,
    create_tests_base,
...
def test_create_tests(mocker: MockFixture) -> None:
    ...
    mock_create_tests_base = mocker.patch(
        "winipedia_utils.testing.create_tests.create_tests_base"
    )
    mock_create_tests_for_src_package = mocker.patch(
        "winipedia_utils.testing.create_tests.create_tests_for_src_package"
    )
...
def test_create_tests_base(tmp_path: Path, mocker: MockFixture) -> None:
    ...
    try:
        ...
        mock_copy_package = mocker.patch(
            "winipedia_utils.testing.create_tests.copy_package"
        )
        ...
        assert_with_msg(
            "winipedia_utils.testing.tests.conftest" in conftest_content,
...
def test_create_tests_for_src_package(mocker: MockFixture) -> None:
    ...
    mock_create_test_package = mocker.patch(
        "winipedia_utils.testing.create_tests.create_test_package"
    )
    mock_create_test_module = mocker.patch(
        "winipedia_utils.testing.create_tests.create_test_module"
    )
...
def test_create_test_package(mocker: MockFixture) -> None:
    ...
    mock_make_test_obj_importpath_from_obj = mocker.patch(
        "winipedia_utils.testing.create_tests.make_test_obj_importpath_from_obj"
    )
    mock_create_module = mocker.patch(
        "winipedia_utils.testing.create_tests.create_module"
    )
...
def test_create_test_module(mocker: MockFixture) -> None:
    ...
    mock_to_path = mocker.patch("winipedia_utils.testing.create_tests.to_path")
    mock_get_test_module_content = mocker.patch(
        "winipedia_utils.testing.create_tests.get_test_module_content"
    )
...
def test_get_test_module_content(mocker: MockFixture) -> None:
    ...
    mock_get_test_obj_from_obj = mocker.patch(
        "winipedia_utils.testing.create_tests.get_test_obj_from_obj"
    )
    mock_get_module_content_as_str = mocker.patch(
        "winipedia_utils.testing.create_tests.get_module_content_as_str"
    )
    mock_get_test_functions_content = mocker.patch(
        "winipedia_utils.testing.create_tests.get_test_functions_content"
    )
    mock_get_test_classes_content = mocker.patch(
        "winipedia_utils.testing.create_tests.get_test_classes_content"
    )
...
def test_main(mocker: MockFixture) -> None:
    ...
    mock_create_tests = mocker.patch(
        "winipedia_utils.testing.create_tests.create_tests"
    )
