...
def test_conftest_exists_and_is_correct() -> None:
    ...
    expected_content = get_conftest_content()
    assert_with_msg(
        correct_conftest_content(conftest_path),
        f"conftest.py has incorrect content.\nExpected: {expected_content}\nActual: {content}",
    )
...
@autouse_session_fixture
def test_all_src_code_in_one_package() -> None:
...
@autouse_session_fixture
def test_project_structure_mirrored() -> None:
